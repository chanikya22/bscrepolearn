...
from connections.bsc.vinculum.invoicedetail.extract import extract_data
from connections.bsc.vinculum.invoicedetail.transform_v2 import transform_data
from connections.bsc.vinculum.invoicedetail.load_v2 import load_data
...
def get_next_date_range(**context):
    ...
    """
    # Configuration
    START_DATE = datetime(2025, 4, 1)  # Your starting date
    END_DATE = datetime(2025, 4,10)  # Your ending date
...
# Create DAG
dag = DAG(
    dag_id='vinculum_invoice_detail_sequential',
    description='Sequential ETL pipeline for Vinculum Invoice Detail data (day by day)',
    schedule_interval=None,  # Manual trigger only
    default_args=default_args,
    start_date=datetime(2025, 3, 9),
    catchup=False,
    tags=['etl', 'vinculum', 'invoicedetail', 'sequential'],
)
...
trigger_next = TriggerDagRunOperator(
    ...
    trigger_dag_id='vinculum_invoice_detail_sequential',  # Self-trigger
