...
from connections.bsc.vinculum.shipmentdetail.extract import extract_data
from connections.bsc.vinculum.shipmentdetail.transform_v2 import transform_data
from connections.bsc.vinculum.shipmentdetail.load import load_data
...
def get_next_date_range(**context):
    ...
    """
    # Configuration
    START_DATE = datetime(2026, 7,16)  # Your starting date
    END_DATE = datetime(2026, 7,19) # Your ending date
...
# Create DAG
dag = DAG(
    dag_id='vinculum_shipment_detail_sequential',
    description='Sequential ETL pipeline for Vinculum Shipment Detail data (day by day)',
    schedule_interval=None,  # Manual trigger only
    default_args=default_args,
    start_date=datetime(2025, 3, 9),
    catchup=False,
    tags=['etl', 'vinculum', 'shipmentdetail', 'sequential'],
)
...
trigger_next = TriggerDagRunOperator(
    ...
    trigger_dag_id='vinculum_shipment_detail_sequential',  # Self-trigger
