...
dag = DAG(
    dag_id='dfm_soda_checks',
    description='dfm pipeline health check ',
    schedule_interval='30 5 * * *',   # Daily at 11:00 AM IST
    default_args=default_args,
    start_date=datetime(2025, 7, 9),
    catchup=False,
    tags=['etl', 'dfm', 'pnl', 'health-check'],
)

data_freshness_task = TrackedPythonOperator(
    task_id='data_freshness_checks',
    python_callable=data_freshness_checks,
    pipeline_name='dfm-soda-checks',
    client_id='dfm',
