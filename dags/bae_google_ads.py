...
from connections.bsc.shopify.google_ads.google_bae.extract import extract_data
from connections.bsc.shopify.google_ads.google_bae.load import load_data
...
# Create DAG directly
dag = DAG(
    dag_id='bae_google_ads_pipeline',
