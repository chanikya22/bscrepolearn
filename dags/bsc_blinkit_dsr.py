...
from connections.bsc.blinkit.sales.extract_load import load as sales_load
from connections.bsc.blinkit.ads.extract_load import load as ads_load
...
dag = DAG(
    ...
    schedule_interval='55 3 * * *',  # Daily at 8:25 AM (IST)
    default_args=default_args,
    start_date=datetime(2025, 12, 17),
    catchup=False,
    tags=['Blinkit','dsr','bsc'],
)
