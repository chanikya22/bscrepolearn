...
from connections.insytscraping.myntra.myntra_sales_report import (
...
from connections.insytscraping.myntra.myntra_ads_report import (
...
from connections.insytscraping.myntra.myntra_process_dsr import (
    trigger_dsr_task,
...
from connections.insytscraping.myntra.myntra_inventory_report import (
    extract as extract_inventory,
    upload_s3_task as upload_inventory_s3,
    validate_s3_task as validate_inventory_s3,
    api_upload_task as api_upload_inventory,
    load_db_task as load_inventory_db,
    validate_db_task as validate_inventory_db
)
...
with DAG(
    dag_id="myntra_dsr",
    description="Myntra DSR Sales-Ads Report Pipeline",
    schedule="0 3 * * *",
    ...
    with TaskGroup(
        ...
        extract_sales_task = TrackedPythonOperator(
            ...
            pipeline_name="myntra_dsr-report",
            client_id="bsc",
            data_type="myntra_dsr-report",
            is_first_task=True,
            is_last_task=False,
    ...
    with TaskGroup(
        ...
        upload_inventory_s3_task = TrackedPythonOperator(
            task_id="upload_s3",
            python_callable=upload_inventory_s3,
            is_first_task=False,
            is_last_task=False,
            failure_email_to=ALERT_EMAILS,
        )
