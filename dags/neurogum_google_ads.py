...
# Create DAG directly
dag = DAG(
    dag_id='neurogum_google_ads_pipeline',
    description='ETL pipeline for Google Ads data extraction and loading for Neurogum',
    ...
    tags=['etl', 'neurogum', 'google-ads', 'marketing', 'api'],
)
start = EmptyOperator(
    task_id='start',
    dag=dag,
...
neurogum_extract_task = TrackedPythonOperator(
...
neurogum_load_task = TrackedPythonOperator(
...
get_all_dates_task >> neurogum_extract_task >> neurogum_load_task >> end