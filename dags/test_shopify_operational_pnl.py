...
# Test Shopify BSC orders

from connections.bsc.shopify_new.bsc.extract import extract_data as shopify_bsc_extract
from connections.bsc.shopify_new.bsc.transform import transform_data_to_postgres as shopify_bsc_transform
from connections.bsc.shopify_new.bsc.load import load_data as shopify_bsc_load

# Test Shopify BAE orders

from connections.bsc.shopify_new.bombae.extract import extract_data as shopify_bae_extract
from connections.bsc.shopify_new.bombae.transform import transform_data_to_postgres as shopify_bae_transform
from connections.bsc.shopify_new.bombae.load import load_data as shopify_bae_load
...
def get_all_date_ranges(**context):
    ...
    """
    pipelines = [
        ('bsc-shopify-orders', 'test-bsc-shopify-orders'),
        ('bae-shopify-orders', 'test-bae-shopify-orders'),
    ]
...
bsc_order_extract_task = TrackedPythonOperator(
    ...
    python_callable=create_extract_wrapper(shopify_bsc_extract, 'bsc-shopify-orders', 'test-bsc-shopify-orders'),
    pipeline_name='bsc-shopify-orders',
    client_id='bsc',
    data_type='test-bsc-shopify-orders',
    is_first_task=True,
...
bsc_order_transform_task = TrackedPythonOperator(
    ...
    python_callable=shopify_bsc_transform,
    pipeline_name='bsc-shopify-orders',
    client_id='bsc',
    data_type='test-bsc-shopify-orders',
    is_last_task=False,
...
bsc_order_load_task = TrackedPythonOperator(
    ...
    python_callable=shopify_bsc_load,
    pipeline_name='bsc-shopify-orders',
    client_id='bsc',
    data_type='test-bsc-shopify-orders',
    is_last_task=True,
...
bae_order_extract_task = TrackedPythonOperator(
    ...
    python_callable=create_extract_wrapper(shopify_bae_extract, 'bae-shopify-orders', 'test-bae-shopify-orders'),
    pipeline_name='bae-shopify-orders',
    client_id='bsc',
    data_type='test-bae-shopify-orders',
    is_first_task=True,
    trigger_rule='none_failed',  # Run if upstream didn't fail
    dag=dag
)
...
bae_order_transform_task = TrackedPythonOperator(
    ...
    python_callable=shopify_bae_transform,
    pipeline_name='bae-shopify-orders',
    client_id='bsc',
    data_type='test-bae-shopify-orders',
    is_last_task=False,
...
bae_order_load_task = TrackedPythonOperator(
    ...
    python_callable=shopify_bae_load,
    pipeline_name='bae-shopify-orders',
    client_id='bsc',
    data_type='test-bae-shopify-orders',
    is_last_task=True,
...
start_task >> check_previous_run_task >> get_all_dates_task >> bae_order_extract_task >> bae_order_transform_task >> bae_order_load_task >> bae_order_complete 

bae_order_complete >> bsc_order_extract_task >> bsc_order_transform_task >> bsc_order_load_task >> bsc_order_complete >> end_task